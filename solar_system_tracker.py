...
# Draw Sun and Orbit Rings once
pygame.draw.circle(bg_surface, SUN_COLOR, (cx, cy), SUN_SIZE)
for p in PLANETS:
    orbit_r = SUN_SIZE + (p["dist"] * ORBIT_SPACING)
    pygame.draw.circle(bg_surface, ORBIT_COLOR, (cx, cy), orbit_r, 1)
# Fonts
